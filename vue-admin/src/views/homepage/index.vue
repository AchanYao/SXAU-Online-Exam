    ...
    <div class="home-total">
      <div class="home-total-item" v-for="(item, index) of homeTotalData">
        <div class="wrapper-item">
          ...
          <color-line :color="item.color" :id='"main"+index' :optionData="item.data" height="70px"
                      width="180px"></color-line>
        </div>
      </div>
    </div>

    <el-row :gutter="0" class="home-part1">
      <el-col :lg="12" :md="24">
        <div class="near-six-month">
          <div class="title">
            <p class="title-value">平台近期数据统计</p>
          </div>
          <div class="content" ref="near-six-month-chart">
            <near-six-month height="100%" width="100%"></near-six-month>
          </div>
        </div>
      </el-col>
      <el-col :lg="8" :md="16" :sm="24" class="detail-item-wrapper">
        <!--
        ...
        -->
        <div class="home-detail-item" style="background: #1ad2a4">
          <div class="name item-name">用户数</div>
          <div class="value">
            <span class="num user-num">{{ userCount }}</span>人
          </div>
        </div>
      </el-col>
      <el-col :lg="4" :md="8" :sm="24">
        <div class="rank">
          <div class="title">
            <p class="title-value">学生刷题榜</p>
          </div>
          <div class="content" ref="rankContent">
            <ul class="wrapper-user">
              <li class="user-item" v-for="item of rankList">
                <img :src="item.avatar" alt="" class="avatar" height="35" loading="lazy" width="35">
                <div class="user-info">
...
<script>
  ...
  import {getHomeTotal, getRank, getUsersCount} from '@/api/homepage'
  import {coursesCount} from '../../api/courses'
