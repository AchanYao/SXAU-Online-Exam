...
-- Records of answer
-- ----------------------------
INSERT INTO `answer` VALUES (1, '2020-01-29 12:59:10', '2020-01-29 12:59:13', 1, '<p>.java</p>');
INSERT INTO `answer` VALUES (2, '2020-01-29 13:05:22', '2020-01-29 13:05:25', 2, '<p>.class</p>');
INSERT INTO `answer` VALUES (4, '2020-01-29 13:21:16', '2020-01-29 13:21:20', 3, '<p>T</p>');
INSERT INTO `answer` VALUES (5, '2020-01-29 13:37:48', '2020-01-29 13:37:52', 4, '<pre class=\"language-java\"><code>public class Main {\r\n\r\n    public static void main(String[] args) {\r\n        System.out.println(\"hello world\");\r\n    }\r\n}\r\n</code></pre>');
...
CREATE TABLE `course`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程实体' ROW_FORMAT = Dynamic;
...
INSERT INTO `course` VALUES (6, '2020-03-14 14:47:45', '2020-03-14 14:47:45', 'TestCourse', '修改测试', '120934', 1);
INSERT INTO `course` VALUES (7, '2020-03-14 16:14:17', '2020-03-14 16:14:17', 'test course', '测试课程', 'TestCourse', 0);
...
-- ----------------------------
INSERT INTO `fill_blank_question` VALUES (1, '2020-01-29 13:02:31', '2020-01-29 13:02:35', 2, 1);
...
-- ----------------------------
INSERT INTO `multiple_choice` VALUES (1, 1, '2020-01-29 12:58:23', '2020-01-29 12:58:26', '.class', '.java', '.jar', '.exe');
...
CREATE TABLE `program_input`  (
  ...
  CONSTRAINT `program_input_ibfk_1` FOREIGN KEY (`program_id`) REFERENCES `program_question` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `program_question`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `question_id`(`question_id`) USING BTREE,
  CONSTRAINT `program_question_ibfk_1` FOREIGN KEY (`question_id`) REFERENCES `question` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- ----------------------------
INSERT INTO `program_question` VALUES (1, '2020-01-29 13:36:16', '2020-01-29 13:36:19', 4);
...
CREATE TABLE `question`  (
  ...
  `modify_user_id` int(11) NULL DEFAULT NULL COMMENT '修改该记录教师id',
  `modify_student_id` int(11) NULL DEFAULT NULL COMMENT '建议该题的学生id',
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of question
-- ----------------------------
INSERT INTO `question` VALUES (1, '2020-03-07 16:57:03', '2020-03-07 16:57:03', 1, 1, 'Java源文件扩展名', 1, NULL, NULL);
INSERT INTO `question` VALUES (2, '2020-03-07 16:57:05', '2020-03-07 16:57:05', 2, 1, 'Java字节码文件扩展名（#）', 1, NULL, NULL);
INSERT INTO `question` VALUES (3, '2020-03-07 16:57:07', '2020-03-07 16:57:07', 3, 1, 'Java是平台无关的', 1, NULL, NULL);
INSERT INTO `question` VALUES (4, '2020-03-07 16:57:08', '2020-03-07 16:57:08', 5, 1, '用Java语言输出 hello world', 1, NULL, NULL);
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES (1, 'ROLE_student', '学生');
INSERT INTO `role` VALUES (2, 'ROLE_teacher', '教师');
INSERT INTO `role` VALUES (3, 'ROLE_principal', '课程组组长');
INSERT INTO `role` VALUES (4, 'ROLE_admin', '管理员');
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '学生表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `subjective_question`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `question_id`(`question_id`) USING BTREE,
  CONSTRAINT `subjective_question_ibfk_1` FOREIGN KEY (`question_id`) REFERENCES `question` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- ----------------------------
INSERT INTO `t_or_f_question` VALUES (1, '2020-01-29 13:27:38', '2020-01-29 13:27:42', 3);
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '教师表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '教师组表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of teacher_group
-- ----------------------------
INSERT INTO `teacher_group` VALUES (1, '2020-03-16 15:19:33', '2020-03-16 15:19:33', 'TeacherGroup1', 2, 2);
...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '教师与教师组中间表' ROW_FORMAT = Dynamic;
...
INSERT INTO `teacher_mid_group` VALUES (8, '2020-03-16 15:19:33', '2020-03-16 15:19:33', 1, 1);
INSERT INTO `teacher_mid_group` VALUES (9, '2020-03-16 15:19:33', '2020-03-16 15:19:33', 2, 1);
INSERT INTO `teacher_mid_group` VALUES (10, '2020-03-16 15:19:33', '2020-03-16 15:19:33', 4, 1);
INSERT INTO `teacher_mid_group` VALUES (11, '2020-03-16 15:19:33', '2020-03-16 15:19:33', 7, 1);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '20171611101', '$2a$10$tVnlcn3CYW5TaDcroR7pGO/f3CAlSANXo3f3WFJNZCFPbyX2yrIi.', '2020-03-13 15:16:51', '2020-03-13 15:16:51', 0);
...
INSERT INTO `user` VALUES (24, 'admin', '$2a$10$zsVgzrYFv1GAldtx9ujbi.WjDsgM80WiG2OgGtKcVQOT5t9XEgwxa', '2020-03-11 11:54:33', '2020-03-11 11:54:33', 1);
...
INSERT INTO `user_role` VALUES (23, 24, 4, '2020-03-08 11:22:09', '2020-03-08 11:22:12');
