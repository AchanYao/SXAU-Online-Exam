<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="教师号" width="110px">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="教师号" prop="number">
...
import { addTeacher, deleteTeacherById, pageTeachers, updateTeacher } from '../../../api/users/teachers'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      pageTeachers(this.listQuery).then(response => {
    ...
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          addTeacher(this.temp).then((result) => {
