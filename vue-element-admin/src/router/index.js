...
import userManageRouter from '@/router/modules/user-manage'
import classManageRouter from '@/router/modules/class-manage'
import courseManageRouter from '@/router/modules/courses'
...
export const asyncRoutes = [
  ...
  courseManageRouter,
  {
    ...
    children: [
      {
        path: 'all',
        component: () => import('@/views/teacher-group/all'),
        name: 'AllTeacherGroups',
        meta: { title: '课程组' }
      },
      {
        path: 'details/:id(\\d+)',
